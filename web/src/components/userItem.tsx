...
export default function UserItem({ userId, filename, progress, speed,fileSize,receiverSize}:UserItemProps){
    return (
        <div class='bg-gradient-to-r from-gray-600 to-gray-900 m-4 p-2 rounded-lg' data-file={`${userId}-${filename}`}>
          ...
          {/* <p class='text-gray-300'>SendSize: {formatBytes(receiverSize)} </p>
          <p class='text-gray-300'>FileSize: {formatBytes(fileSize)} </p> */}
